...
const MODEL_GENRE_ROUTING = {
  ...
  "Romance": { primary: "gpt-4o", reason: "Romance benefits from accessible, emotionally engaging prose with strong dialogue and genre convention awareness.", styleBeat: "Romantic & passionate with character-driven emotional arcs", alts: ["claude-sonnet-4-5"] },
  ...
  "Adventure": { primary: "gpt-4o", reason: "Adventure writing thrives on fast pacing, punchy prose, and page-turning momentum.", styleBeat: "Fast-paced, action-oriented with cinematic set pieces", alts: ["claude-sonnet-4-5"] },
  ...
  "Young Adult": { primary: "gpt-4o", reason: "YA needs accessible language, relatable voice, and strong genre convention awareness for teen audiences.", styleBeat: "Accessible, emotionally resonant with coming-of-age themes", alts: ["claude-sonnet-4-5"] },
  "Children's": { primary: "gpt-4o", reason: "Children's writing needs simple, engaging language with whimsical tone and age-appropriate vocabulary.", styleBeat: "Whimsical & playful with age-appropriate vocabulary", alts: ["claude-sonnet-4-5"] },
  ...
  "Science": { primary: "claude-sonnet-4-5", reason: "Science writing requires factual precision, research synthesis, and the ability to make complex topics accessible.", styleBeat: "Academic but accessible with awe-inspiring explanations", alts: ["claude-opus-4-5", "gpt-4-turbo"] },
  "Technology": { primary: "claude-sonnet-4-5", reason: "Technology books need up-to-date accuracy, clear technical explanations, and practical examples.", styleBeat: "Clear, technically precise with forward-looking perspective", alts: ["gpt-4-turbo", "gpt-4o"] },
