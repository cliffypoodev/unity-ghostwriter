  ...
  const handleFixAll = async () => {
    ...
    for (let i = 0; i < chaptersWithIssues.length; i++) {
      ...
      try {
        ...
        const aiFixableCategories = ['interiority_repetition', 'sensory_opener', 'tense_drift', 'the_noun_opener', 'philosophical_ending', 'fiction_cliche', 'recap_bloat', 'formulaic_intro', 'car_opening_cliche', 'simile_overload', 'narrator_repetition', 'participle_chain', 'ai_sensory_default'];
