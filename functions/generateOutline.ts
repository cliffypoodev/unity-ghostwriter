...
const MODEL_MAP = {
  ...
  "gemini-pro":        { provider: "google",    modelId: "gemini-2.5-pro-preview-03-25", defaultTemp: 0.6, maxTokensLimit: null },
...
const AUTHOR_VOICE_DESCRIPTIONS = {
  hemingway:"Spare, direct prose. Short sentences. Subtext through omission.",king:"Conversational, building dread. Pop culture references. Everyman characters.",morrison:"Lyrical, rhythmic. Rich cultural texture. Non-linear time.",mccarthy:"Stark, biblical. No quotation marks. Landscape as character.",gaiman:"Whimsical yet dark. Fairy-tale cadence. Mythology remixed.",flynn:"Sharp, sardonic. Unreliable narrators. Twists rooted in psychology.",sanderson:"Systematic worldbuilding. Clear action choreography. Satisfying payoffs.",hoover:"Emotional gut-punches. First-person intimacy. Relationship dynamics.",patterson:"Ultra-short chapters. Cliffhanger endings. Fast pacing.",atwood:"Intellectual, layered. Social commentary. Dry wit.",basic:"Clean, neutral, competent prose.",
  'colleen-hoover':'Emotional rawness, dual POV, trauma-forward. Accessible but never shallow.','taylor-jenkins-reid':'Nonlinear timelines, ensemble casts, emotional excavation.','emily-henry':'Sharp banter, witty, self-deprecating. Romantic tension through intellectual friction.','sally-rooney':'Minimal dialogue tags, stripped-down precise prose. Class-conscious.','nicholas-sparks':'Sentimental, fate-driven, Southern settings. Clean accessible.','penelope-douglas':'Dark romance, moral ambiguity, intense close first-person.','francine-rivers':'Faith through behavior. Clean warm prose. Grace and forgiveness.','gillian-flynn':'Unreliable narration, sharp venomous prose. Dark female interiority.','tana-french':'Atmospheric, suffocating. Literary but not ornate.','james-patterson':'Ultra-short chapters, micro-cliffhangers. Plot mechanics king.','michael-connelly':'Procedural precision, LA texture, moral fatigue.','harlan-coben':'Suburban secrets. Brisk accessible conversational.','lee-child':'Tactical spatial logic. Minimal declarative military-efficiency.','toni-morrison':'Lyrical never decorative. Nonlinear memory. Trust the image.','cormac-mccarthy':'No quotation marks. Spare biblical cadence. Vast indifferent landscape.','kazuo-ishiguro':'Narrator withholds unknowingly. Formal distant. Tragedy in silences.','zadie-smith':'Confident essayistic. Social forces and individuals. Ever-present wit.','donna-tartt':'Rich classical sentences. Obsessive intellectual characters.','agatha-christie':'Plot mechanics priority. Clean efficient slightly dry.','louise-penny':'Community relationships load-bearing. Warm but evil beneath.','kate-atkinson':'Structure as meaning. Witty knowing. Tragedy and absurdity coexist.','stephen-king':'Character before dread. Small town darkness. Ordinary life twisted.','shirley-jackson':'Horror in the unsaid. Domestic dread. Precise deceptively calm.','paul-tremblay':'Literary anxiety-soaked. Ambiguous endings by design.','brandon-sanderson':'Magic has rules and costs. Meticulous plot. Clear functional prose.','nk-jemisin':'Structural experimentation. Systemic violence in world architecture.','joe-abercrombie':'Subvert expectations. Sharp darkly funny. No destiny saves.','robin-hobb':'Deep attachment then suffering. Warm immersive. Hope withdrawn.','ve-schwab':'Distinct multi-POV. Atmospheric world-building. Villains have best arguments.','terry-pratchett':'Satirical comedic warm. Footnote-driven wit. Humanist.','andy-weir':'Real-time problem-solving. Witty self-deprecating. Accurate science.','ursula-le-guin':'SF as anthropology. Elegant unhurried prose. Rich interiority.','philip-k-dick':'Unreliable reality. Functional frantic prose. Philosophical through plot.','william-gibson':'Fragmented associative image-dense. Atmospheric tech.','erik-larson':'Dual parallel narratives. Documentable scenes. Cinematic nonfiction.','david-grann':'Nonfiction as mystery. Clean gripping. Moral implication.','malcolm-gladwell':'Counterintuitive, specific stories. Warm accessible.','jon-krakauer':'Author obsession. Technical danger. Urgent prose.','michelle-mcnamara':'Writer obsession, victims as people. Literary lyrical.','robert-kolker':'Victims as living people. Systemic failures. Empathetic careful.','hilary-mantel':'Close third present tense. Power dynamics. Dense never slow.','ken-follett':'Multi-generational. Architecture as character. Clear propulsive.','colm-toibin':'Unsaid carries weight. Precise spare melancholy.','john-green':'Philosophical teens. Wit as connection. Underplayed emotion.','leigh-bardugo':'Crew distinct voices. Punchy atmospheric savage.','rainbow-rowell':'Passions treated seriously. Warm funny honest.','brene-brown':'Lead with vulnerability. Warm direct. Not above the problem.','james-clear':'Mechanism and application. Clear efficient.','ryan-holiday':'Historical anchored Stoic framework. Direct austere.',
};
...
=== END THRILLER CONSTRAINT ===\n`;
    ...
    const ctxHdr = `═══ PROJECT CONTEXT ═══\nTYPE: ${(spec.book_type||'fiction').toUpperCase()} | GENRE: ${spec.genre||'Fiction'}${spec.subgenre?' / '+spec.subgenre:''} | BEAT: ${(BEAT_STYLES[spec.beat_style||spec.tone_style||'']||{name:'Not specified'}).name||spec.beat_style||'Not specified'} | LANG: ${spec.language_intensity}/4${spec.spice_level>0?' | SPICE: '+spec.spice_level+'/4':''}${spec.author_voice&&spec.author_voice!=='basic'?' | VOICE: '+spec.author_voice:''}${spec.target_audience?' | AUDIENCE: '+spec.target_audience:''}\nPhase 1 settings MANDATORY.\n═══════════════════════`;
    const systemPrompt = `${ctxHdr}\n\n${buildAuthorModeBlock(spec)}\n\n${CONTENT_GUARDRAILS}\n\n${ANTI_REPETITION_RULES}\n\n${scopeLockBlock}${shortEroticaConstraint}${thrillerScopeLock}\n\nYou are a professional story architect and book outline generator. Your PRIMARY obligation is to prevent: (1) flat repetition — same tension level recycled, (2) scope bleed — chapters covering same ground under different headings, (3) orphaned threads — elements introduced and never paid off. Return only valid JSON. No prose, no preamble, no commentary outside the JSON.
