  ...
  try {
    const subgenres = {
      fiction: {
        ...
        "Romance": ["Contemporary", "Historical", "Paranormal", "Romantic Suspense", "Enemies-to-Lovers", "Slow Burn", "Rom-Com", "Dark Romance", "Steamy Romance", "Mafia Romance", "Billionaire Romance", "Sports Romance", "Reverse Harem", "Why Choose", "Omegaverse"],
