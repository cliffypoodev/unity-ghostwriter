...
const AUTHOR_VOICES_MAP = {hemingway:"Terse, declarative. Iceberg theory.",king:"Conversational, building dread.",austen:"Witty ironic social commentary.",tolkien:"Mythic elevated world-building.",morrison:"Lyrical poetic sensory.",rowling:"Accessible whimsical wordplay.",mccarthy:"Sparse biblical. No quotes.",atwood:"Sharp sardonic precise.",gaiman:"Mythic modern fairy-tale.",pratchett:"Satirical comedic warm.",le_guin:"Spare elegant philosophical.",vonnegut:"Dark humor absurdist.",garcia_marquez:"Lush magical realism.",chandler:"Hardboiled noir cynical.",christie:"Puzzle-box clean prose.",gladwell:"Nonfiction counterintuitive.",bryson:"Humorous self-deprecating.",sagan:"Awe-inspiring poetic wonder.",didion:"Cool precise observation.",'colleen-hoover':'Emotional rawness, dual POV, trauma-forward. Accessible but never shallow.','taylor-jenkins-reid':'Nonlinear timelines, ensemble casts, emotional excavation. Warm but not saccharine.','emily-henry':'Sharp banter, witty, self-deprecating internal monologue. Romantic tension through intellectual friction.','sally-rooney':'Minimal dialogue tags, stripped-down precise prose. Clinical intimacy. Class-conscious.','nicholas-sparks':'Sentimental, fate-driven, Southern settings. Clean accessible prose. Earned inevitability.','penelope-douglas':'Dark romance, moral ambiguity, intense close first-person. Do not soften edges.','francine-rivers':'Faith through behavior not exposition. Clean warm prose. Grace and forgiveness as engine.','gillian-flynn':'Unreliable narration, sharp venomous prose. Dark female interiority. Reveals reframe everything.','tana-french':'Atmospheric, suffocating. Literary but not ornate. Detective mystery matters as much as murder.','james-patterson':'Ultra-short chapters, micro-cliffhangers. Short sentences. Plot mechanics are king.','michael-connelly':'Procedural precision, LA texture, moral fatigue. Clean propulsive prose.','harlan-coben':'Suburban secrets cracked open. Brisk accessible conversational prose. Earned twists.','lee-child':'Tactical spatial logic. Minimal declarative military-efficiency prose. Sparse loaded dialogue.','toni-morrison':'Lyrical never decorative. Nonlinear memory. Community as character. Trust the image.','cormac-mccarthy':'No quotation marks. Spare biblical cadence. Violence matter-of-fact. Vast indifferent landscape.','kazuo-ishiguro':'Narrator withholds unknowingly. Polished formal distant. Reader understands more. Tragedy in silences.','zadie-smith':'Confident essayistic. Social forces and individuals. Ever-present wit. Race class culture examined.','donna-tartt':'Rich classical sentences. Obsessive intellectual characters. Beauty and corruption linked.','agatha-christie':'Plot mechanics priority. Clue or red herring. Clean efficient slightly dry. Surprising yet inevitable.','louise-penny':'Community relationships load-bearing. Warm but evil beneath. Human frailty with compassion.','kate-atkinson':'Structure as meaning. Timelines intersect. Witty knowing. Tragedy and absurdity coexist.','stephen-king':'Character before dread. Small town darkness. Pop culture grounds supernatural. Ordinary life twisted.','shirley-jackson':'Horror in the unsaid. Domestic spaces suffocating. Precise formal deceptively calm. Leave uncertainty.','paul-tremblay':'Supernatural with rational possibility. Literary anxiety-soaked. Ambiguous endings by design.','brandon-sanderson':'Magic has rules and costs. World-building through experience. Meticulous plot. Clear functional prose.','nk-jemisin':'Structural experimentation as meaning. Systemic violence in world architecture. Assured confrontational.','joe-abercrombie':'Subvert expectations. Flawed heroes, logical villains. Sharp darkly funny. No destiny saves.','robin-hobb':'Deep attachment then suffering. Suffocating first-person intimacy. Warm immersive. Hope withdrawn.','ve-schwab':'Distinct multi-POV voices. No moral clarity. Atmospheric world-building. Villains have best arguments.','andy-weir':'Real-time problem-solving. Witty self-deprecating voice. Accurate science. Every solution creates problems.','ursula-le-guin':'SF as anthropology. Elegant unhurried prose. Invented societies reflecting ours. Rich interiority.','philip-k-dick':'Unreliable reality. Ordinary people in incomprehensible systems. Functional frantic prose.','william-gibson':'Fragmented associative image-dense. Atmospheric tech. Corporate power dominant. Glamorous decay.','erik-larson':'Dual parallel narratives colliding. Documentable scenes. Cinematic propulsive nonfiction.','david-grann':'Nonfiction as mystery. Clean gripping prose. End on moral implication not just fact.','malcolm-gladwell':'Counterintuitive claim, specific stories. Concrete human face for abstract ideas. Warm accessible.','jon-krakauer':'Author obsession as story. Technical danger. Urgent self-lacerating prose. Deep light research.','michelle-mcnamara':'Writer obsession, victims as people. Literary lyrical despite subject. Dark humor survival.','robert-kolker':'Victims as living people. Systemic failures matter. Empathetic careful never exploitative.','hilary-mantel':'Close third present tense. Power dynamics everywhere. Period detail in action. Dense never slow.','ken-follett':'Multi-generational. Architecture as character. Clear propulsive. Historical backdrop personal stakes.','colm-toibin':'Unsaid carries weight. Exiled from emotions. Precise spare melancholy. Endings resist resolution.','john-green':'Philosophical teens. Wit as connection. Distinctive self-aware first-person. Underplayed emotion.','leigh-bardugo':'Crew with distinct voices. Heist planning exciting. Punchy atmospheric savage. Defined by sacrifice.','rainbow-rowell':'Passions treated seriously. Geek culture not punchlines. Warm funny honest. Shared interest tension.','brene-brown':'Lead with vulnerability. Research not clinical. Warm direct. Not above the problem.','james-clear':'Mechanism and application. Story→concept→application→summary. Clear efficient not shallow.','ryan-holiday':'Historical anchored lessons. Stoic framework. Direct austere not sentimental. Challenge not coddle.'};

const FICTION_ENDING_TYPES={1:"Type A: Mid-action cliffhanger.",2:"Type B: Revelation recontextualizes.",3:"Type C: Concrete sensory image.",4:"Type D: Gut-punch dialogue — last line.",5:"Type E: Quiet mundane action contrasting intensity."};
const NONFICTION_ENDING_TYPES={1:"Quiet resonant image.",2:"Reframing sentence.",3:"Brief poem/aphorism.",4:"Lingering question.",5:"Return to opening vignette."};
