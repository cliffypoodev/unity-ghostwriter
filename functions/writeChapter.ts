...
const endCheck=checkSceneEnding(text);if(endCheck.violation)V.push({type:'weak_ending',label:endCheck.lastSentence,count:1,max:0,excess:1,rule:endCheck.rule});return V;}
